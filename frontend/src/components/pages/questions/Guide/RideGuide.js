        ...
        <div className="container">
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">How do I book a ride?</h4>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
          ...
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Fill up our rider form</h5>
              <p>At the <Link to="/" className="light-blue-text">homepage</Link> you can find the ride hailing section at the beginning of the page</p>
              <p>Upon entering the Trike <Link to="/ride_hail" className="light-blue-text">ride hailing page</Link>, simply fill out the form. These inlcude your <b>personal information</b> (automatically filled up based on your profile) and <b>Pickup and delivery address</b></p>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
