        ...
        <div className="container">
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">Trike Privacy Policy</h4>
              <p>
          ...
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">Interpretation and Definitions</h4>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Interpretation</h5>
              <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Definitions</h5>
              <p>For the purposes of this Privacy Policy:</p>
              <p><b>Account</b> means a unique account created for You to access our Service or parts of our Service.</p>
              <p><b>Company </b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Trike Delivery Services, 1202 Daisy St. Employees Village Gulang-Gulang Lucena City.</p>
              ...
              <p><b>Country</b> refers to: Philippines</p>
              ...
              <p><b>Website</b> refers to Trike, accessible from https://www.trike.com.ph</p>
          ...
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">Collecting and Using Your Personal Data</h4>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Types of Data Collected</h5>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
              <h6 className="fw-6">Personal Data</h6>
          ...
          <div className="row">
            <div className="col s12">
              <h6 className="fw-6">Usage Data</h6>
          ...
          <div className="row">
            <div className="col s12">
              <h6 className="fw-6">Information from Third-Party Social Media Services</h6>
          ...
          <div className="row">
            <div className="col s12">
              <h6 className="fw-6">Tracking Technologies and Cookies</h6>
          ...
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Use of Your Personal Data</h5>
          ...
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Retention of Your Personal Data</h5>
          ...
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Transfer of Your Personal Data</h5>
          ...
          <div className="row">
            <div className="col s12">
              <h6 className="fw-6">Business Transactions</h6>
              <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
              <h6 className="fw-6">Law enforcement</h6>
              <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
              <h6 className="fw-6">Other legal requirements</h6>
          ...
          <div className="row">
            <div className="col s12">
              <h5 className="fw-6">Security of Your Personal Data</h5>
              <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
            </div>
          </div>
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">Children's Privacy</h4>
          ...
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">Links to Other Websites</h4>
          ...
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">Changes to this Privacy Policy</h4>
          ...
          <div className="row">
            <div className="col s12">
              <h4 className="fw-6">Contact Us</h4>
              <p>If you have any questions about this Privacy Policy, You can contact us:</p>
              <p>-By email: info@trike.com.ph</p>
            </div>
          </div>
        </div>
      </section>
