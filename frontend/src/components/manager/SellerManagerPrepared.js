              ...
              <div className="col flex-row middle s12">
                ...
                {!userLoading && user && (
                  <div className="flex-col">
                    <h4 className="m-0 flex-row middle flow">Prepared Orders</h4>
...
SellerManagerPrepared.propTypes = {
...
export default connect(mapStateToProps, { getOrders, getOrder })(SellerManagerPrepared);